# **Volcano Plot Generator (T-Test / ANOVA)**
...
* **Smart Statistical Analysis:**  
  * **2-Group Comparison:** Automatically runs a **Welch's t-test** for each feature.  
  * **3+ Group Comparison:** Automatically runs an **ANOVA** followed by **Tukey's HSD** post-hoc test to get all pairwise comparisons and adjusted p-values.  
...
2. **Select Columns (in Sidebar):**  
   ...
   * **Select Groups to Analyze:** Choose the specific groups you want to compare.  
     * If you select **2 groups**, the app will run a t-test.  
     * If you select **3 or more groups**, the app will run an ANOVA.  
...
* In the app, you would set Select Grouping Column: to **"Condition"** and Select \*First\* Gene Column: to **"Gene\_1"**.
...
install.packages(c(  
  ...
  "stringr", "ggplot2", "ggrepel", "DT", "purrr"  
))  
